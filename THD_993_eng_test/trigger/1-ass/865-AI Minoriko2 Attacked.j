function Trig_AI_Minoriko2_Attacked_Conditions takes nothing returns boolean
...
function Trig_AI_Minoriko2_Attacked_Actions takes nothing returns nothing
...
function InitTrig_AI_Minoriko2_Attacked takes nothing returns nothing
endfunction
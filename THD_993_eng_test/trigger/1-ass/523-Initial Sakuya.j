function Trig_Initial_Sakuya_Actions takes nothing returns nothing
    ...
    call FirstAbilityInit('A04H')
    call FirstAbilityInit('A099')
    call FirstAbilityInit('A09A')
    call FirstAbilityInit('A0QT')
    call FirstAbilityInit('A0IL')
    call FirstAbilityInit('A1I9')
    call FirstAbilityInit('A1IA')
    call FirstAbilityInit('A09G')
    call FirstAbilityInit('A09D')
    call FirstAbilityInit('A0V4')
    call FirstAbilityInit('A09F')
    call FirstAbilityInit('A03P')
    if h == null then

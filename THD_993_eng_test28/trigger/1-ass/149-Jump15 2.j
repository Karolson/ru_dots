function Trig_Jump15_2_Conditions takes nothing returns boolean
...
function Trig_Jump15_2_Actions takes nothing returns nothing
    local unit u = GetTriggerUnit()
    local location a = GetRectCenter(gg_rct_Jump15bot)
    local location b = GetRectCenter(gg_rct_Jump15top2)
    local real ang = AngleBetweenPoints(a, b)
    local real dst = DistanceBetweenPoints(a, b)
    local effect e
    call DisableTrigger(gg_trg_Jump15_2)
    ...
    call EnableTrigger(gg_trg_Jump15_2)
...
function InitTrig_Jump15_2 takes nothing returns nothing
    set gg_trg_Jump15_2 = CreateTrigger()
    call YDWETriggerRegisterEnterRectSimpleNull(gg_trg_Jump15_2, gg_rct_Jump15bot)
    call TriggerAddCondition(gg_trg_Jump15_2, Condition(function Trig_Jump15_2_Conditions))
    call TriggerAddAction(gg_trg_Jump15_2, function Trig_Jump15_2_Actions)
endfunction
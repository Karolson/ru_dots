function Trig_AI_Nue_Attacked_Conditions takes nothing returns boolean
...
function Trig_AI_Nue_Attacked_Actions takes nothing returns nothing
    ...
    elseif IsUnitType(attacker, UNIT_TYPE_HERO) then
        ...
        elseif GetUnitCurrentOrder(h) == OrderId("inferno") then
...
function InitTrig_AI_Nue_Attacked takes nothing returns nothing
endfunction
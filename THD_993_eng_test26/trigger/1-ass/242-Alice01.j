...
function Trig_Alice01_Actions takes nothing returns nothing
    ...
    local integer n
    call AbilityCoolDownResetion(caster, GetSpellAbilityId(), 12 - GetUnitAbilityLevel(caster, 'A0GV') * 1 - GetUnitAbilityLevel(caster, 'A0GY') * 1)
    ...
    call DisplayTextToPlayer(GetOwningPlayer(caster), 0.0, 0.0, "Shanghai: " + I2S(n) + "/" + I2S(max))
    set caster = null
    set u = null
    set g = null
endfunction

function Trig_Youmu03_Follow takes nothing returns nothing
    ...
    if q and l then
        ...
        elseif d <= 1500.0 then
            ...
            call TimerStart(t, 0.5, false, function Trig_Youmu03_Follow)
        else
...
function Trig_Youmu03_Init takes unit h, boolean illusion returns nothing
...
function Trig_Youmu03_Actions takes nothing returns nothing
    ...
    elseif GetTriggerEventId() == EVENT_PLAYER_UNIT_SUMMON and GetUnitTypeId(GetSummoningUnit()) != 'o00O' then
        call Trig_Youmu03_Init(GetSummonedUnit(), true)
